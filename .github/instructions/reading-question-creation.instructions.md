# READING-QUESTION-CREATION.md — Create Reading Checkpoint Questions for a Section

## Inputs you will receive
	- Target section file:
		TARGETSECTION = `./source/apex-sections/sec_{sectionTitle}.ptx`
		TARGETQUESTIONBANK = `./source/chpt{chapterID}-questions.ptx`
	- Section content (full text or excerpt).
	- Optional: where checkpoints should appear (mid-narrative, end-of-subsection, etc.).

## Primary goal
	Write **10 reading checkpoint questions** that test understanding of the content inside the TARGETSECTION.

## Question design requirements
	- Produce **10 questions**.
	- Options for the question types and Pretext structure are listed in QUESTIONTEMPLATES and other `.ptx` files in this repository.
	- Questions should align with the TARGETSECTION.
	- Each question must have:
		- a **short, descriptive title** (not a restatement of the prompt).
		- comments indicating where the question should be located inside the narrative of the TARGETSECTION
	- Feedback must **teach**:
		- Avoid “Correct!” / “Nope” style feedback.
		- Explain the concept that makes the right choice right.

## Output mode
	As a pull request, append the new questions to the corresponding `<section>` of the TARGETQUESTIONBANK
...
<exercise label="chkpt-multiple-choice">
	...
	<choices randomize="yes">
		<choice>
			<statement>
				<p>INCORRECT CHOICE 1</p>
			</statement>
			<feedback>
				<p>FEEDBACK FOR CHOICE 1</p>
			</feedback>
		</choice>
		<choice>
			<statement>
				<p>INCORRECT CHOICE 2</p>
			</statement>
			<feedback>
				<p>FEEDBACK FOR CHOICE 2</p>
			</feedback>
		</choice>
		<choice correct="yes">
			<statement>
			...
			<feedback>
				<p>FEEDBACK FOR CORRECT CHOICE</p>
			</feedback>
		</choice>
		<choice>
			<statement>
				<p>INCORRECT CHOICE 3</p>
			</statement>
			<feedback>
				<p>FEEDBACK FOR CHOICE 3</p>
			</feedback>
		</choice>
	</choices>
</exercise>
...
<exercise label="chkpt-multiple-answer">
	<title>QUESTION TITLE</title>
	<statement>
		<p>
			QUESTION STATEMENT
...
#### True Statement:
<exercise label="chkpt-true-false-true">
	<title>QUESTION TITLE</title>
...
#### False Statement:
<exercise label="chkpt-true-false-false">
	<title>QUESTION TITLE</title>
...
<exercise label="chkpt-matching">
	...
	<cardsort>
		...
		<match>
		<premise>ITEM 3</premise>
		<response>TARGET 3</response>
		</match>
		<match>
		<premise>ITEM 4</premise>
		<response>TARGET 4</response>
		</match>
		<match>
		<premise>ITEM 5</premise>
		<response>TARGET 5</response>
		</match>
	</cardsort>
</exercise>

### Clickable-Area Question Template
<exercise label="chkpt-fill-in-the-blank">
	<title>QUESTION TITLE</title>
	<statement>
		<p>
			Click on all the items below that satisfy SOME PROPERTY.
		</p>
	</statement>
	<areas>
		<p>
			THERE CAN BE NON_CLICKABLE TEXT ANYWHERE AROUND THE <area> TAGS
			<area>CORRECT ITEM 1</area>
			<area>CORRECT ITEM 2</area>
			<area correct="no">INCORRECT ITEM 1</area>
			<area>CORRECT ITEM 3</area>
			<area correct="no">INCORRECT ITEM 2</area>
		</p>
	</areas>
	<feedback>
		<p>
...
### STATIC Fill-In Question Template
<exercise label="fillin-template">
	...
	<evaluation>
		<evaluate>
			<test>
				...
				<feedback>A variable of type <c>int</c> is appropriate for whole number ages.</feedback>
			</test>
			<test>
				<strcmp>.*</strcmp>
				<feedback>
		...
		<evaluate>
			<test>
				...
				<feedback>An integer variable may be initialized to a value.</feedback>
			</test>
			<test>
				<strcmp>.*</strcmp>
				<feedback>Use <c>5</c> as the initial value of the variable.</feedback>
			</test>
		</evaluate>
	</evaluation>
</exercise>

### DYNAMIC Fill-In Question Template
<exercise label="dynamic-simple-formula">
	<title>Fill-In Formula (Dynamic)</title>
	<statement>
		<p>
			Find a formula for a cubic function <m>f(x)</m> that has roots at <m>x=<eval obj="x1"/></m>,
			<m>x=<eval obj="x2"/></m>,
