...
},
{
  ...
  "level": "2",
  "url": "sec-chain-rule.html#related-rates-matching",
  "type": "Exercise",
  "number": "2",
...
},
{
  ...
  "level": "2",
  "url": "sec-chain-rule.html#chain-rule-matching-template",
  "type": "Exercise",
  "number": "3",
...
{
  "id": "sec-implicit-diff",
  "level": "1",
  "url": "sec-implicit-diff.html",
  "type": "Section",
  "number": "1.2",
  "title": "Implicit Differentiation",
  "body": " Implicit Differentiation   Unscramble the Derivative   Rearrange the blocks to form a valid derivative statement.                 List the Steps  order steps   Suppose is a function of , and we want to find given the equation: . List the implicit differentiation steps in the correct order in the right column.                      Product Rule Match   The product rule is given by the formula . Match two functions on the left with the product rule they would produce on the right.                           Match the Reason to the Step  matching steps to order   Suppose we want apply implicit differentiation to find for the equation . Match the one or more tasks on the right that was applied in each step on the left.     apply the derivative with respect to both sides     sum rule     chain rule  power rule     factor     divide both sides by     quotient rule  simplify       State or describe what the word implicit refers to in implicit differentiation .       Suppose you are given the derivative, , but not the function itself. Describe the type of information you can obtain about .     "
},
{
  "id": "hparson-derivative",
  "level": "2",
  "url": "sec-implicit-diff.html#hparson-derivative",
  "type": "Exercise",
  "number": "4",
  "title": "Unscramble the Derivative.",
  "body": " Unscramble the Derivative   Rearrange the blocks to form a valid derivative statement.               "
},
{
  "id": "ex-parson-steps",
  "level": "2",
  "url": "sec-implicit-diff.html#ex-parson-steps",
  "type": "Exercise",
  "number": "5",
  "title": "List the Steps.",
  "body": " List the Steps  order steps   Suppose is a function of , and we want to find given the equation: . List the implicit differentiation steps in the correct order in the right column.                    "
},
{
  "id": "ex-matching-step-reason",
  "level": "2",
  "url": "sec-implicit-diff.html#ex-matching-step-reason",
  "type": "Exercise",
  "number": "6",
  "title": "Product Rule Match.",
  "body": " Product Rule Match   The product rule is given by the formula . Match two functions on the left with the product rule they would produce on the right.                         "
},
{
  "id": "ex-matching-step-reason1",
  "level": "2",
  "url": "sec-implicit-diff.html#ex-matching-step-reason1",
  "type": "Exercise",
  "number": "7",
  "title": "Match the Reason to the Step.",
  "body": " Match the Reason to the Step  matching steps to order   Suppose we want apply implicit differentiation to find for the equation . Match the one or more tasks on the right that was applied in each step on the left.     apply the derivative with respect to both sides     sum rule     chain rule  power rule     factor     divide both sides by     quotient rule  simplify    "
},
{
  "id": "sec-implicit-diff-6",
  "level": "2",
  "url": "sec-implicit-diff.html#sec-implicit-diff-6",
  "type": "Exercise",
  "number": "8",
  "title": "",
  "body": "  State or describe what the word implicit refers to in implicit differentiation .    "
},
{
  "id": "sec-implicit-diff-7",
  "level": "2",
  "url": "sec-implicit-diff.html#sec-implicit-diff-7",
  "type": "Exercise",
  "number": "9",
  "title": "",
  "body": "  Suppose you are given the derivative, , but not the function itself. Describe the type of information you can obtain about .    "
},
{
  "id": "sec-differentials",
  "level": "1",
  "url": "sec-differentials.html",
  "type": "Section",
  "number": "2.1",
  "title": "Differentials",
  "body": " Differentials   Why Tangent Lines Work   Which statement best describes how a tangent line, , approximates at the point of tangency ?     closely resembles the curve near .  Correct—the tangent line shares the same instantaneous rate of change, so it hugs the curve nearby.    closely resembles the graph of for any .  Not true—tangent lines only approximate well near a given point (i.e., locally), not globally.    exactly matches the curve near .  Not true—tangent lines only approximate well near a given point.    is the most accurate approximation of near .  Not correct—the error grows as you move away from the tangent point.      Linearization vs. Actual Change   Match each symbol to its meaning in the context of linearization.  Assume is some value of .       The true change in when changes     The linear (approximate) change in     A chosen small change in     The slope of the tangent line at      Differential Notation   The symbol in differential notation is literally a fraction of two separate quantities, and .    False — is one symbol for the derivative, not an actual fraction. The resemblance to a fraction is helpful but can be misleading.     Complete the Linearization Formula   Fill in the blanks to complete the formula for the linear approximation of at .   + ( - )               "
},
{
  "id": "APEX-PROTEUS-differentials-1-v1",
  "level": "2",
  "url": "sec-differentials.html#APEX-PROTEUS-differentials-1-v1",
  "type": "Exercise",
  "number": "10",
...
{
  "id": "APEX-PROTEUS-differentials-2-v1",
  "level": "2",
  "url": "sec-differentials.html#APEX-PROTEUS-differentials-2-v1",
  "type": "Exercise",
  "number": "11",
...
{
  "id": "APEX-PROTEUS-differentials-3-v1",
  "level": "2",
  "url": "sec-differentials.html#APEX-PROTEUS-differentials-3-v1",
  "type": "Exercise",
  "number": "12",
...
},
{
  ...
  "level": "2",
  "url": "sec-differentials.html#chkpt-diff-fill-in",
  "type": "Exercise",
  "number": "13",
...
},
{
  ...
  "level": "2",
  "url": "sec-newton.html#APEX-PROTEUS-newton-2-v1",
  "type": "Exercise",
  "number": "15",
  "title": "The Role of the Initial Guess.",
  "body": " The Role of the Initial Guess   Which of the following is the best reason why Newton's Method succeeded even with the initial guess not being very close to the root of ?     Newton's Method always works no matter where you start.  Not true—sometimes it diverges. The success here was not guaranteed.    The tangent lines still led toward the root despite a rough initial guess.  Correct—Newton's Method is often robust to imperfect starting points.    The derivative was zero at .  Incorrect—the derivative was not zero; a zero derivative would actually make Newton's Method fail.    "
},
{
  "id": "APEX-PROTEUS-newton-2-v2",
  "level": "2",
  "url": "sec-newton.html#APEX-PROTEUS-newton-2-v2",
  "type": "Exercise",
  "number": "16",
...
},
{
  ...
  "level": "2",
  "url": "sec-newton.html#APEX-PROTEUS-newton-3-v1",
  "type": "Exercise",
  "number": "17",
...
},
{
  ...
  "level": "2",
  "url": "sec-newton.html#chkpt-daniel-question",
  "type": "Exercise",
  "number": "18",
...
},
{
  ...
  "level": "2",
  "url": "sec-newton.html#APEX-PROTEUS-graph-MVT-1-v1",
  "type": "Exercise",
  "number": "19",
...
},
{
  ...
  "body": " Area Between Curves   Matching Question   Match the region on the left to the expression representing its area on the right. (one to many)           -axis                                                        Multiple-Choice   The region between and is best integrated:     With respect to (bottom ➜ top)    With respect to (left ➜ right)    With respect to (left ➜ right)    With respect to (bottom ➜ top)      Multiple-Choice   The region between and is best integrated:     With respect to (bottom ➜ top)    With respect to (left ➜ right)    With respect to (left ➜ right)    With respect to (bottom ➜ top)     "
},
{
  "id": "APEX-PROTEUS-area-between-curves-1-v1",
  "level": "2",
  "url": "sec-area-between-curves.html#APEX-PROTEUS-area-between-curves-1-v1",
  "type": "Exercise",
  "number": "20",
  "title": "Matching Question.",
  "body": " Matching Question   Match the region on the left to the expression representing its area on the right. (one to many)           -axis                                                      "
},
{
  "id": "APEX-PROTEUS-area-between-curves-2-v1",
  "level": "2",
  "url": "sec-area-between-curves.html#APEX-PROTEUS-area-between-curves-2-v1",
  "type": "Exercise",
  "number": "21",
  "title": "Multiple-Choice.",
  "body": " Multiple-Choice   The region between and is best integrated:     With respect to (bottom ➜ top)    With respect to (left ➜ right)    With respect to (left ➜ right)    With respect to (bottom ➜ top)    "
},
{
  "id": "APEX-PROTEUS-area-between-curves-3-v1",
  "level": "2",
  "url": "sec-area-between-curves.html#APEX-PROTEUS-area-between-curves-3-v1",
  "type": "Exercise",
  "number": "22",
  "title": "Multiple-Choice.",
  "body": " Multiple-Choice   The region between and is best integrated:     With respect to (bottom ➜ top)    With respect to (left ➜ right)    With respect to (left ➜ right)    With respect to (bottom ➜ top)    "
},
{
  ...
  "number": "3.2",
  "title": "Disk Method",
  "body": " Disk Method        Cross-Sectional Volume Formula   A solid is oriented along the -axis from to , and its cross-sectional area at position is . Which integral gives the volume of the solid?       The volume of a thin slice at position is approximately (area times thickness). Summing these slices and taking a limit gives the definite integral .       We do not square the cross-sectional area. Each slice has volume , not . Squaring the radius (not the area) appears in the Disk Method, which is a specific case.       The factor of is not needed in the general formula. It only appears when the cross section is a circle (as in the Disk Method), because the area of a circle of radius is .       The derivative of the area function does not give volume. Volume is found by integrating cross-sectional area over the length of the solid.        Disk Method Radius Identification   The curve is revolved about the -axis from to . Using the Disk Method, what is the radius function and the resulting volume integral?     , so   The radius of each disk is the distance from the -axis to the curve, which is . Squaring gives , so the volume is .     , so   The radius is the -value of the curve at each , which is , not . The function tells us the distance from the axis of rotation to the curve.     , so   The radius is correct, but remember the Disk Method formula uses , not . So we need inside the integral.     , so   The curve is , not . The radius equals the -value of the curve being revolved.        Disk Method vs. Washer Method   A student is setting up a volume integral for a solid of revolution. Which condition determines whether the disk method should be used instead of the washer method ?       When one boundary of the region being rotated lies on the axis of rotation.    Correct! When one edge of the region coincides with the axis of rotation, the inner radius is zero, the cross-sectional \"washer\" collapses to a solid disk, and the volume formula simplifies to . As soon as a gap opens between the region and the axis, both an outer radius and an inner radius are present and the washer formula is required.      When the region is rotated about a horizontal axis.    Not quite. Both the disk method and the washer method work for rotation about either a horizontal or a vertical axis. The orientation of the axis determines whether you integrate with respect to or , but it does not determine which method to use. The deciding factor is whether a gap exists between the region and the axis.      When the region is bounded by a single function.    This is a common mix-up. In both methods the region is typically bounded by two curves (or a curve and a boundary line). What distinguishes the methods is not the number of bounding functions, but whether one of those boundaries is the axis of rotation itself. If it is, the inner radius vanishes and you use the disk method; if neither boundary coincides with the axis, you need the washer method.      When the boundaries of the region are given by functions of .    The method does not depend on whether the boundaries are functions of or . Both methods can be applied in either case; the key is whether one of those boundaries coincides with the axis of rotation.      When the boundaries of a region intersect at one point.    The number of intersection points does not determine which method to use. Even if the boundaries intersect at only one point, they may still both lie above the axis of rotation, creating a gap that requires the washer method. Conversely, if they intersect at one point but one boundary coincides with the axis, the disk method applies.        Washer Method Matching (version 1)   Consider the region bounded by and for .       Match each inner and outer radius pair with the axis of rotation that they correspond to in the Washer Method.   ⤵︎  ⤵︎     In the Washer Method, the cross section is an annular ring (washer). The volume of each washer is , where is the outside radius and is the inside radius.                                    Washer Method Matching (version 2)   Consider the region bounded by and for .       Match each inner and outer radius pair with the axis of rotation that they correspond to in the Washer Method.   ⤵︎  ⤵︎     In the Washer Method, the cross section is an annular ring (washer). The volume of each washer is , where is the outside radius and is the inside radius.                               Construct the Volume Integral   Suppose the region bounded by is revolved about the -axis.  Using the blocks below, construct integral that gives the volume using the washer method?                  Washer Method: Identify the Error   The region bounded by and for is revolved about the line . A student sets up the following volume integral using the washer method: Which statement best identifies the error in the student's work?      The radii were measured from instead of from the axis .    Correct! Because the axis lies below the region, each radius must be increased by to account for the gap between the axis and the nearest boundary. In general, when the axis is , the radii are and .      The limits of integration should run from to to reflect the position of the axis.    Incorrect. The limits of integration are determined by the x -extent of the region being rotated, which is still . Shifting the axis of rotation never changes the limits; it changes the radius expressions instead.      The outer and inner radii are swapped; it should be and since on .    Incorrect. On we have (check: at , ), so is indeed the outer boundary. The student has the orientation right but is measuring radii from the wrong baseline.      The formula should use instead of because the solid is generated by a full rotation.    Incorrect. The washer-method formula is ; the factor of (not ) already accounts for a full revolution. The factor appears in the shell method, where it represents the circumference of a cylindrical shell.        Washer Method: Deduce the Axis of Rotation   Consider the region bounded by and for . This region is revolved about a horizontal axis using the washer method.  At , the resulting washer has outer radius and inner radius . What is the axis of rotation?               Washer Method: Select All Correct Volume Integrals   The region bounded by and for is revolved about the -axis. Select every integral below that correctly computes the volume of the resulting solid.            Correct. Using the washer method with vertical slices: the outer radius is and the inner radius is , so .           Correct. Using the shell method with horizontal shells (integrating in ): the shell at height has radius (distance to the -axis) and length (from to ), giving , which equals the washer-method result.           Incorrect. This computes , which is not the washer formula. The correct integrand is , not . These are equal only when one radius is zero.           Incorrect. This integral gives the volume of the inner solid alone (the region below only). The volume of the full washer-shaped solid requires subtracting the inner volume from the outer, i.e., .           Incorrect. This is missing the radius factor inside the integral. In the shell method, both the radius and the height of each shell must appear: the integrand should be , not just .      "
},
{
  "id": "APEX-PROTEUS-disk-1-v1",
  "level": "2",
  "url": "sec-disk.html#APEX-PROTEUS-disk-1-v1",
  "type": "Exercise",
  "number": "23",
  "title": "Cross-Sectional Volume Formula.",
  "body": " Cross-Sectional Volume Formula   A solid is oriented along the -axis from to , and its cross-sectional area at position is . Which integral gives the volume of the solid?       The volume of a thin slice at position is approximately (area times thickness). Summing these slices and taking a limit gives the definite integral .       We do not square the cross-sectional area. Each slice has volume , not . Squaring the radius (not the area) appears in the Disk Method, which is a specific case.       The factor of is not needed in the general formula. It only appears when the cross section is a circle (as in the Disk Method), because the area of a circle of radius is .       The derivative of the area function does not give volume. Volume is found by integrating cross-sectional area over the length of the solid.     "
},
{
  "id": "APEX-PROTEUS-disk-2-v1",
  "level": "2",
  "url": "sec-disk.html#APEX-PROTEUS-disk-2-v1",
  "type": "Exercise",
  "number": "24",
  "title": "Disk Method Radius Identification.",
  "body": " Disk Method Radius Identification   The curve is revolved about the -axis from to . Using the Disk Method, what is the radius function and the resulting volume integral?     , so   The radius of each disk is the distance from the -axis to the curve, which is . Squaring gives , so the volume is .     , so   The radius is the -value of the curve at each , which is , not . The function tells us the distance from the axis of rotation to the curve.     , so   The radius is correct, but remember the Disk Method formula uses , not . So we need inside the integral.     , so   The curve is , not . The radius equals the -value of the curve being revolved.     "
},
{
  "id": "APEX-PROTEUS-disk-3-v1",
  "level": "2",
  "url": "sec-disk.html#APEX-PROTEUS-disk-3-v1",
  "type": "Exercise",
  "number": "25",
  "title": "Disk Method vs. Washer Method.",
  "body": " Disk Method vs. Washer Method   A student is setting up a volume integral for a solid of revolution. Which condition determines whether the disk method should be used instead of the washer method ?       When one boundary of the region being rotated lies on the axis of rotation.    Correct! When one edge of the region coincides with the axis of rotation, the inner radius is zero, the cross-sectional \"washer\" collapses to a solid disk, and the volume formula simplifies to . As soon as a gap opens between the region and the axis, both an outer radius and an inner radius are present and the washer formula is required.      When the region is rotated about a horizontal axis.    Not quite. Both the disk method and the washer method work for rotation about either a horizontal or a vertical axis. The orientation of the axis determines whether you integrate with respect to or , but it does not determine which method to use. The deciding factor is whether a gap exists between the region and the axis.      When the region is bounded by a single function.    This is a common mix-up. In both methods the region is typically bounded by two curves (or a curve and a boundary line). What distinguishes the methods is not the number of bounding functions, but whether one of those boundaries is the axis of rotation itself. If it is, the inner radius vanishes and you use the disk method; if neither boundary coincides with the axis, you need the washer method.      When the boundaries of the region are given by functions of .    The method does not depend on whether the boundaries are functions of or . Both methods can be applied in either case; the key is whether one of those boundaries coincides with the axis of rotation.      When the boundaries of a region intersect at one point.    The number of intersection points does not determine which method to use. Even if the boundaries intersect at only one point, they may still both lie above the axis of rotation, creating a gap that requires the washer method. Conversely, if they intersect at one point but one boundary coincides with the axis, the disk method applies.     "
},
{
  "id": "APEX-PROTEUS-disk-4-v1",
  "level": "2",
  "url": "sec-disk.html#APEX-PROTEUS-disk-4-v1",
  "type": "Exercise",
  "number": "26",
  "title": "Washer Method Matching (version 1).",
  "body": " Washer Method Matching (version 1)   Consider the region bounded by and for .       Match each inner and outer radius pair with the axis of rotation that they correspond to in the Washer Method.   ⤵︎  ⤵︎     In the Washer Method, the cross section is an annular ring (washer). The volume of each washer is , where is the outside radius and is the inside radius.                                 "
},
{
  "id": "APEX-PROTEUS-disk-4-v2",
  "level": "2",
  "url": "sec-disk.html#APEX-PROTEUS-disk-4-v2",
  "type": "Exercise",
  "number": "27",
  "title": "Washer Method Matching (version 2).",
  "body": " Washer Method Matching (version 2)   Consider the region bounded by and for .       Match each inner and outer radius pair with the axis of rotation that they correspond to in the Washer Method.   ⤵︎  ⤵︎     In the Washer Method, the cross section is an annular ring (washer). The volume of each washer is , where is the outside radius and is the inside radius.                             "
},
{
  "id": "APEX-PROTEUS-disk-5-v1",
  "level": "2",
  "url": "sec-disk.html#APEX-PROTEUS-disk-5-v1",
  "type": "Exercise",
  "number": "28",
  "title": "Construct the Volume Integral.",
  "body": " Construct the Volume Integral   Suppose the region bounded by is revolved about the -axis.  Using the blocks below, construct integral that gives the volume using the washer method?               "
},
{
  "id": "APEX-PROTEUS-disk-6-v1",
  "level": "2",
  "url": "sec-disk.html#APEX-PROTEUS-disk-6-v1",
  "type": "Exercise",
  "number": "29",
  "title": "Washer Method: Identify the Error.",
  "body": " Washer Method: Identify the Error   The region bounded by and for is revolved about the line . A student sets up the following volume integral using the washer method: Which statement best identifies the error in the student's work?      The radii were measured from instead of from the axis .    Correct! Because the axis lies below the region, each radius must be increased by to account for the gap between the axis and the nearest boundary. In general, when the axis is , the radii are and .      The limits of integration should run from to to reflect the position of the axis.    Incorrect. The limits of integration are determined by the x -extent of the region being rotated, which is still . Shifting the axis of rotation never changes the limits; it changes the radius expressions instead.      The outer and inner radii are swapped; it should be and since on .    Incorrect. On we have (check: at , ), so is indeed the outer boundary. The student has the orientation right but is measuring radii from the wrong baseline.      The formula should use instead of because the solid is generated by a full rotation.    Incorrect. The washer-method formula is ; the factor of (not ) already accounts for a full revolution. The factor appears in the shell method, where it represents the circumference of a cylindrical shell.     "
},
{
  "id": "APEX-PROTEUS-disk-7-v1",
  "level": "2",
  "url": "sec-disk.html#APEX-PROTEUS-disk-7-v1",
  "type": "Exercise",
  "number": "30",
  "title": "Washer Method: Deduce the Axis of Rotation.",
  "body": " Washer Method: Deduce the Axis of Rotation   Consider the region bounded by and for . This region is revolved about a horizontal axis using the washer method.  At , the resulting washer has outer radius and inner radius . What is the axis of rotation?            "
},
{
  "id": "APEX-PROTEUS-disk-8-v1",
  "level": "2",
  "url": "sec-disk.html#APEX-PROTEUS-disk-8-v1",
  "type": "Exercise",
  "number": "31",
  "title": "Washer Method: Select All Correct Volume Integrals.",
  "body": " Washer Method: Select All Correct Volume Integrals   The region bounded by and for is revolved about the -axis. Select every integral below that correctly computes the volume of the resulting solid.            Correct. Using the washer method with vertical slices: the outer radius is and the inner radius is , so .           Correct. Using the shell method with horizontal shells (integrating in ): the shell at height has radius (distance to the -axis) and length (from to ), giving , which equals the washer-method result.           Incorrect. This computes , which is not the washer formula. The correct integrand is , not . These are equal only when one radius is zero.           Incorrect. This integral gives the volume of the inner solid alone (the region below only). The volume of the full washer-shaped solid requires subtracting the inner volume from the outer, i.e., .           Incorrect. This is missing the radius factor inside the integral. In the shell method, both the radius and the height of each shell must appear: the integrand should be , not just .     "
},
{
  "id": "sec-shell-method",
  "level": "1",
  "url": "sec-shell-method.html",
  "type": "Section",
  "number": "3.3",
  "title": "Shell Method",
...
{
  "id": "chkpt-matching-diffeq-solutions",
  "level": "2",
...
{
  "id": "showing-separable-forms-chkpt-3",
  "level": "2",
...
{
  "id": "chkpt-sequences-cardsort-01",
  "level": "2",
...
{
  "id": "chkpt-sequences-cardsort-03",
  "level": "2",
...
{
  "id": "chkpt-seq-converge-properties",
  "level": "2",
...
{
  "id": "chkpt-seq-monotonic-identify",
  "level": "2",
...
{
  "id": "chkpt-seq-monotonic-converge",
  "level": "2",
